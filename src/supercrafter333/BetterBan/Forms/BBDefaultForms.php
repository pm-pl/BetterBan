...
use DateTime;
use supercrafter333\BetterBan\libs\_08c0c383e0a72f04\dktapps\pmforms\CustomForm;
use supercrafter333\BetterBan\libs\_08c0c383e0a72f04\dktapps\pmforms\CustomFormResponse;
use supercrafter333\BetterBan\libs\_08c0c383e0a72f04\dktapps\pmforms\element\Input;
use supercrafter333\BetterBan\libs\_08c0c383e0a72f04\dktapps\pmforms\element\Label;
use supercrafter333\BetterBan\libs\_08c0c383e0a72f04\dktapps\pmforms\element\Slider;
use supercrafter333\BetterBan\libs\_08c0c383e0a72f04\dktapps\pmforms\element\Toggle;
use supercrafter333\BetterBan\libs\_08c0c383e0a72f04\dktapps\pmforms\MenuForm;
use supercrafter333\BetterBan\libs\_08c0c383e0a72f04\dktapps\pmforms\MenuOption;
...
class BBDefaultForms {
	...
	public static function openMenuForm() : MenuForm {
		if (!BetterBan::pmformsExists()) {
			throw BetterBan::pmformsNotFoundError();
		}
		...
		return new CustomForm(
			...
			function (Player $submitter, CustomFormResponse $response) : void {
				...
				if ($mins == 0 && $hours == 0 && $days == 0 && $months == 0 && $years == 0) {
					...
					if ($mins !== 0) {
						$bantime->modify("+$mins minutes");
					}
					if ($hours !== 0) {
						$bantime->modify("+$hours hours");
					}
					if ($days !== 0) {
						$bantime->modify("+$days days");
					}
					if ($months !== 0) {
						$bantime->modify("+$months months");
					}
					if ($years !== 0) {
						$bantime->modify("+$years years");
					}
